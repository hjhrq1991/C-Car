    ...
    private void drawText(Canvas canvas) {
        switch (status) {
            ...
            case STATUS_GAME_PLAY:
                ...
                promptText(canvas, mContext.getString(R.string.loading));
                break;
            case STATUS_GAME_FINISHED:
                textPaint.setTextSize(50);
                promptText(canvas, mContext.getString(R.string.loading_finished));
                break;
            case STATUS_GAME_OVER:
                textPaint.setTextSize(60);
                promptText(canvas, mContext.getString(R.string.game_over));
                break;
        }
    }
