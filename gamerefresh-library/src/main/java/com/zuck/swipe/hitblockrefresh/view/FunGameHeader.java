...
public class FunGameHeader extends FrameLayout {
    ...
    private void initView(AttributeSet attrs) {
        ...
        topMaskView = createMaskTextView(mContext.getString(R.string.mask_top), 20, Gravity.BOTTOM);
        bottomMaskView = createMaskTextView(mContext.getString(R.string.mask_bottom), 18, Gravity.TOP);
