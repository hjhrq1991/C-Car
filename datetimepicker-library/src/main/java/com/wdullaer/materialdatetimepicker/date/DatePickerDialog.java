...
public class DatePickerDialog extends DialogFragment implements
    ...
    public interface OnDateSetListener {
         ...
         */
        void onDateSet(DatePickerDialog view, int year, int monthOfYear, int dayOfMonth, int tag);
    }
    ...
    public static DatePickerDialog newInstance(OnDateSetListener callBack, int year,
                                               int monthOfYear,
                                               int dayOfMonth, int tag) {
        DatePickerDialog ret = new DatePickerDialog();
        ret.initialize(callBack, year, monthOfYear, dayOfMonth, tag);
        return ret;
    }

    public void initialize(OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth, int tag) {
        mCallBack = callBack;
            ...
            public void onClick(View v) {
                ...
                if (mCallBack != null) {
                    mCallBack.onDateSet(DatePickerDialog.this, mCalendar.get(Calendar.YEAR),
                            mCalendar.get(Calendar.MONTH) + 1, mCalendar.get(Calendar.DAY_OF_MONTH), tag);
                }
                dismiss();
            }
        });
