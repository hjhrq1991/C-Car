...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener {
    ...
    private OnCancelSetListener mCancelCallBack;
    ...
    public interface OnCancelSetListener {
        void onCancel();
    }
    ...
    public static TimePickerDialog newInstance(OnTimeSetListener callback, OnCancelSetListener cancelCallBack,
                                               int hourOfDay, int minute, boolean is24HourMode) {
        TimePickerDialog ret = new TimePickerDialog();
        ret.initialize(callback, cancelCallBack, hourOfDay, minute, is24HourMode);
        return ret;
    }

    public void initialize(OnTimeSetListener callback, OnCancelSetListener cancelCallBack,
                           int hourOfDay, int minute, boolean is24HourMode) {
        mCallback = callback;
    ...
    public void setOnCanceSetlListener(OnCancelSetListener cancelListener) {
        this.mCancelCallBack = cancelListener;
    }
