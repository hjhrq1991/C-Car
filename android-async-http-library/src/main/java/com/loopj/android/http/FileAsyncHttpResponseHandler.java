...
//    }
//
//    public FileAsyncHttpResponseHandler(File file, Looper looper) {
//        super(looper);
//        assert (file != null);
//        this.mFile = file;
//    }
//
//    public FileAsyncHttpResponseHandler(Context context, Looper looper) {
//        super(looper);
...
//        assert (context != null);
//        try {
//            return File.createTempFile("temp_", "_handled", context.getExternalCacheDir());
//        } catch (Throwable t) {
