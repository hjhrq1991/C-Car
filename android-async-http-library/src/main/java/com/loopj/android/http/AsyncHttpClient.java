...
//        String queryString = getUrlWithQueryString(isUrlEncodingEnabled, url, params);
//
//        System.out.println("============do get=============" + queryString);
//        return sendRequest(httpClient, httpContext, new HttpGet(queryString), null, responseHandler, context);
//    }
//
//    /**
